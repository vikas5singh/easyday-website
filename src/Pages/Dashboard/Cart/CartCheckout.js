...
export default function Securecheckout() {
    ...
    }, [pay.addressId, pay.serviceType, pay?.promocode?.code, pay?.tipAmount, totalcartPrice]);

    console.log("cartDetailData", state?.cartData?.data, cartDetailData, pay?.addressId);
