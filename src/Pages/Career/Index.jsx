...
import { blogList } from "../../Redux/actions";
      ...
      <section className="blog-list">
        <div className="banner">
          <div className="banner-image-container">
            <img
              loading="lazy"
              src="https://neighborly-ride.s3.amazonaws.com/1734893340207openning_bg.jpg"
              alt={`banner`}
              className="img-fluid"
        ...
        <Container className="py-5">
          <Row>
            <Col lg="12" className="my-2 pb-4">
              <div className="section-header mb-3  heading-wrap">
                <h2>Choose your careers!</h2>
              </div>
            </Col>
            {Data &&
              Data?.map((item, index) => {
                return (
                  <>
                    <Col lg="6" md="6" sm="12" key={index} className="my-2">
                      <Link
                        to={`/career/${item?.slug}`}
                        //  to="/blog-detail/"
