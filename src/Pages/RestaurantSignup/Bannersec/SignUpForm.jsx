...
const SignUpForm = ({ showSignUp, setShowSignUp }) => {
  ...
  let storeList = (homeData || [])?.filter((s) => ["PIZZA", "FOOD"].includes(s.storeType)).map(({ _id, label, storeType }) => ({
    label: label,
    value: _id,
  }))
  const initialValues = {
          ...
          <Fragment>
            ...
            >
              <Modal.Header className="border-0" closeButton>
                <Modal.Title>
                  Sign <span className="theme-clr"> Up</span> To <span className="theme-clr">Restaurant</span>.
                </Modal.Title>
              </Modal.Header>
              <p className="px-3">Join our platform and bring your restaurant to a wider audience. Fill out the form below to get started!</p>
