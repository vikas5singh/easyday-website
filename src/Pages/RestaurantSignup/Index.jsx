...
export const DriverSignUp = () => {
  ...
  return (
    <>
      {/* <Header /> */}
      <div className="py-2">
        <DriverNavigation title="Restaurant" isApp={false} SignUpForm={SignUpForm} />
        <BannerSec title="Restaurant" isApp={false} image="restaurant1.png" />
        <WelcomeSection />
        <OurService data={homeData?.resdata} />
        <BlogSection />
        <IconSec title="Restaurant" text="shop" desc=" Grab your car, bike, scooter, or even shoes and deliver
                  whenever you want—for an hour, a weekend, or throughout the
                  week." />
        <HowItWork title="Restaurant" isApp={false} />
        <DeliveryRequirement title="Restaurant" isApp={false} />
