...
import { freshMarkettDetail, restaurantDetail } from "../../Redux/actions";
import moment from "moment";

const Tacosbanner = (props) => {
  const dispatch = useDispatch();
  const detail = useSelector((s) => s.restaurant?.data);
      ...
      <div>
        <div className="banner-tacos position-relative">
          <div className="banner-content">
            <h1 className="text-capitalize">{detail.name}</h1>
            <p>
              <svg
            ...
            <p>
              ...
              Hours :{" "}
              {detail?.openingTime
                ? moment(detail.openingTime, ["HH:mm"]).format("hh:mm A") +
                  " To " +
                  moment(detail.closingTime, ["HH:mm"]).format("hh:mm A")
                : "00:00"}
            </p>
          </div>
