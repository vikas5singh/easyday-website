...
import { addCart, blogList } from "../../Redux/actions";
...
export default function BlogSection(props) {
    ...
    const Data = useSelector((s) => s.Blog?.data);
    ...
    return (
        <section className="container py-5 mt-2">
            <div className="section-header text-center heading-wrap">
                <h2 className="">Our Blogs & News</h2>
                <p>Discover top blogs & news loved by our customers</p>
                <p>&nbsp;</p>
            </div>
