...
import { vehicleTypes, documentDriver, driverRegister } from "../../../Redux/Vehicles/action";
          ...
          <Fragment>
            ...
            >
              <Modal.Header className="border-0" closeButton>
                <Modal.Title>
                  Sign <span className="theme-clr"> Up</span> To <span className="theme-clr"> Driver.</span>
                </Modal.Title>
              </Modal.Header>
              <p className="px-3">Join our team as a driver! Fill out the form below to get started and become a part of our community!</p>
              <Modal.Body>
